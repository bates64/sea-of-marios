...
extern EvtScript EVS_TryFearReaction;
extern EvtScript EVS_JrTroopa_Death;
...
EvtScript EVS_SetupFearReaction = {
...
EvtScript EVS_HandleEvent = {
    ...
    Switch(LVar0)
        ...
        CaseEq(EVENT_HIT)
            ...
            SetConst(LVar1, ANIM_MageJrTroopa_Hurt)
            ExecWait(EVS_Enemy_Hit)
            ExecWait(EVS_SetupFearReaction)
            ExecWait(EVS_TryFearReaction)
        CaseEq(EVENT_DEATH)
            SetConst(LVar0, PRT_BASE)
            SetConst(LVar1, ANIM_MageJrTroopa_Hurt)
            ExecWait(EVS_Enemy_Hit)
...
EvtScript EVS_TakeTurn = {
    ...
    Wait(15)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, (DAMAGE_TYPE_MAGIC | DAMAGE_TYPE_NO_CONTACT), 0, 0, dmgSpell, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
        CaseEq(0)
...
EvtScript EVS_JrTroopa_Death = {
    ...
    Call(SetIdleAnimations, ACTOR_SELF, PRT_MAGE, Ref(DefeatedAnims))
    Wait(60)
...
ActorBlueprint MageJrTroopa = {
    .flags = 0,
    .maxHP = mage_jr_troopa::hp,
    .type = ACTOR_TYPE_JR_TROOPA_5,
    .level = ACTOR_LEVEL_JR_TROOPA_5,
    .partCount = ARRAY_COUNT(mage_jr_troopa::ActorParts),
    .partsData = mage_jr_troopa::ActorParts,
    .initScript = &mage_jr_troopa::EVS_Init,
    .statusTable = mage_jr_troopa::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 0,
