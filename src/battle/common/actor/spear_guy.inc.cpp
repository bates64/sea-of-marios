...
Formation ForwardSpearFormation = {
    ACTOR_BY_POS(battle::actor::SpearGuy, SummonPos, 100, .var0 = AVAL_State_SpearForward),
};

Formation UpwardSpearFormation = {
    ACTOR_BY_POS(battle::actor::SpearGuy, SummonPos, 100, .var0 = AVAL_State_SpearUpward),
};
...
ActorBlueprint SpearGuy = {
    ...
    .partsData = spear_guy::ActorParts,
    .initScript = &spear_guy::EVS_Init,
    .statusTable = spear_guy::SpearGuyStatusTable,
    .escapeChance = 50,
    .airLiftChance = 85,
    .hurricaneChance = 80,
    .spookChance = 70,
