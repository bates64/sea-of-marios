...
EvtScript EVS_TakeTurn = {
    ...
    Else
        ...
        Wait(30)
        Call(ActorSpeak, MSG_Intro_BattleRM_Talk_One, ACTOR_SELF, PRT_MAIN, ANIM_Goomates_Red_CryTalk, ANIM_Goomates_Red_CryIdle)
        // Call(SetIdleAnimations, ACTOR_SELF, PRT_MAIN, Ref(FireAnims))
...
EvtScript EVS_Attack_Firebonk = {
    ...
    Else
        ...
        Call(SetTargetActor, ACTOR_SELF, ACTOR_ENEMY0)
        Call(SetGoalToTarget, ACTOR_SELF)
...
EvtScript EVS_Attack_FireBurst = {
    ...
    Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    Add(LVar2, 30)
    PlayEffect(EFFECT_RING_BLAST, 0, LVar0, LVar1, LVar2, Float(10.0), 15)
    Call(SetGoalToTarget, ACTOR_SELF)
    Wait(2)
    ...
    Switch(LVar0)
        CaseEq(PHASE_PLAYER_BEGIN)
            ...
            IfEq(LVar3, FALSE)
                ...
                // Call(MoveBattleCamOver, 30)
                // Wait(30)
                // Call(ActorSpeak, MSG_Intro_BattleBM_Talk_Zero, ACTOR_SELF, PRT_MAIN, ANIM_Goomates_Blue_Talk, ANIM_Goomates_Blue_Idle)
                ...
                // Call(MoveBattleCamOver, 30)
                // Wait(30)
                // Call(ActorSpeak, MSG_Intro_BattleBM_Talk_One, ACTOR_SELF, PRT_MAIN, ANIM_Goomates_Blue_Talk, ANIM_Goomates_Blue_Idle)
                ...
                Call(MoveBattleCamOver, 30)
                Wait(30)
                Call(ActorSpeak, MSG_Intro_BattleRM_Talk_Zero, ACTOR_ENEMY1, PRT_MAIN, ANIM_Goomates_Red_Talk, ANIM_Goomates_Red_Idle)
            EndIf
