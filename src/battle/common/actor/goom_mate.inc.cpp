...
ActorBlueprint GoomMate = {
    .flags = 0,
    .maxHP = goom_mate::hp,
    .type = ACTOR_TYPE_RED_GOOMBA_BOSS,
    .level = ACTOR_LEVEL_RED_GOOMBA_BOSS,
    .partCount = ARRAY_COUNT(goom_mate::ActorParts),
    .partsData = goom_mate::ActorParts,
    .initScript = &goom_mate::EVS_Init,
    .statusTable = goom_mate::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 0,
