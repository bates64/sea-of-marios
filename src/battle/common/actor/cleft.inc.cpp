...
EvtScript EVS_Attack_Tackle = {
    ...
    Call(EnemyTestTarget, ACTOR_SELF, LVar0, 0, 0, dmgTackle, BS_FLAGS1_INCLUDE_POWER_UPS)
    Switch(LVar0)
...
ActorBlueprint Cleft = {
    .flags = 0,
    .maxHP = cleft::hp,
    .type = ACTOR_TYPE_CLEFT,
    .level = ACTOR_LEVEL_CLEFT,
    .partCount = ARRAY_COUNT(cleft::ActorParts),
    .partsData = cleft::ActorParts,
    .initScript = &cleft::EVS_Init,
    .statusTable = cleft::StatusTable,
    .escapeChance = 80,
    .airLiftChance = 40,
    .hurricaneChance = 40,
    .spookChance = 40,
