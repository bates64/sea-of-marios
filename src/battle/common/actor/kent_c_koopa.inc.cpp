...
extern EvtScript EVS_KentC_GoHome;
extern EvtScript EVS_Flipped_SpinSmashHit;
extern EvtScript EVS_Flipped_SpinSmashDeath;
extern EvtScript EVS_FlipOver;
extern EvtScript EVS_Attack_ShellToss;
extern EvtScript EVS_Attack_HeavyStomp;

extern EvtScript EVS_DropDummyCoins;
extern EvtScript EVS_DropDummyCoin;
...
// Actor Stats
constexpr s32 hp = 35;
constexpr s32 dmgShellTossPlayer = 4;
constexpr s32 dmgShellTossPartner = 2;
constexpr s32 dmgHeavyStomp = 5;
...
ActorPartBlueprint ActorParts[] = {
    ...
    },
    {
        ...
        .opacity = 255,
        .idleAnimations = NULL,
        .defenseTable = FlippedTailDefense,
        .eventFlags = ACTOR_EVENT_FLAGS_NONE,
        .elementImmunityFlags = 0,
        .projectileTargetOffset = { 0, 0 },
    },
    ...
    Switch(LVarD)
        ...
        CaseEq(EVENT_SPIN_SMASH_HIT)
            ...
            Else
                SetConst(LVar0, PRT_MAIN)
                Call(GetActorVar, ACTOR_SELF, AVAR_Anim_Hurt, LVar1)
                ExecWait(EVS_Flipped_SpinSmashHit)
            EndIf
        CaseEq(EVENT_SPIN_SMASH_DEATH)
            ...
            Else
                SetConst(LVar0, PRT_MAIN)
                Call(GetActorVar, ACTOR_SELF, AVAR_Anim_Hurt, LVar1)
                ExecWait(EVS_Flipped_SpinSmashDeath)
                Return
            EndIf
...
EvtScript EVS_TakeTurn = {
    ...
    IfLt(LVar0, 50)
        ...
        Else
            ExecWait(EVS_Attack_HeavyStomp)
        EndIf
    Else
        ExecWait(EVS_Attack_HeavyStomp)
    EndIf
...
EvtScript EVS_Attack_ShellToss = {
    ...
    IfNe(LVarA, 0)
        ...
        Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, SUPPRESS_EVENT_ALL, 0, dmgShellTossPartner, BS_FLAGS1_TRIGGER_EVENTS)
        Call(GetBattleFlags, LVar0)
        IfNotFlag(LVar0, BS_FLAGS1_ATK_BLOCKED)
            Call(SetGoalToTarget, ACTOR_SELF)
            Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
...
EvtScript EVS_Attack_HeavyStomp = {
    Call(UseIdleAnimation, ACTOR_SELF, FALSE)
    Call(EnableIdleScript, ACTOR_SELF, IDLE_SCRIPT_DISABLE)
    Call(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
...
EvtScript EVS_Flipped_SpinSmashHit = {
    Call(SetAnimation, ACTOR_SELF, LVar0, LVar1)
    Set(LVarA, 5)
    ExecWait(EVS_DropDummyCoins)
    Set(LVar2, 0)
    Loop(36)
        Add(LVar2, 30)
...
EvtScript EVS_Flipped_SpinSmashDeath = {
    Call(SetAnimation, ACTOR_SELF, LVar0, LVar1)
    Set(LVarA, 0)
    ExecWait(EVS_DropDummyCoins)
    Set(LVar2, 0)
...
API_CALLABLE((GetCoinTrajectory)) {
...
EvtScript EVS_DropDummyCoin = {
    ...
    Call((GetCoinTrajectory), LVar6, LVar8, LVar0, LVar1, LVar2, LVar3)
...
ActorBlueprint KentCKoopa = {
    .flags = 0,
    .maxHP = kent_c_koopa::hp,
    .type = ACTOR_TYPE_KENT_C_KOOPA,
    .level = ACTOR_LEVEL_KENT_C_KOOPA,
    .partCount = ARRAY_COUNT(kent_c_koopa::ActorParts),
    .partsData = kent_c_koopa::ActorParts,
    .initScript = &kent_c_koopa::EVS_Init,
    .statusTable = kent_c_koopa::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 0,
