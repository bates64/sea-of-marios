...
EvtScript EVS_Attack_Leech = {
    ...
    IfFlag(LVar1, STATUS_FLAG_STONE)
        ...
        Loop(2)
            ...
            Wait(10)
            Wait(2)
            Call(EnemyDamageTarget, ACTOR_SELF, LVarA, DAMAGE_TYPE_IGNORE_DEFENSE, 0, 0, dmgLeech, BS_FLAGS1_NICE_HIT)
    ...
    Else
        ...
        Loop(5)
            ...
            EndIf
            Call(UseIdleAnimation, ACTOR_PLAYER, TRUE)
            Call(EnemyDamageTarget, ACTOR_SELF, LVarA, DAMAGE_TYPE_UNBLOCKABLE | DAMAGE_TYPE_IGNORE_DEFENSE, 0, 0, dmgLeech, BS_FLAGS1_NICE_HIT)
...
Formation SummonFormation = {
    ACTOR_BY_POS(battle::actor::JungleFuzzy, SummonPos, 0),
};

}; // namespace jungle_fuzzy

ActorBlueprint JungleFuzzy = {
    .flags = 0,
    .maxHP = jungle_fuzzy::hp,
    .type = ACTOR_TYPE_JUNGLE_FUZZY,
    .level = ACTOR_LEVEL_JUNGLE_FUZZY,
    .partCount = ARRAY_COUNT(jungle_fuzzy::ActorParts),
    .partsData = jungle_fuzzy::ActorParts,
    .initScript = &jungle_fuzzy::EVS_Init,
    .statusTable = jungle_fuzzy::StatusTable,
    .escapeChance = 30,
    .airLiftChance = 85,
    .hurricaneChance = 80,
    .spookChance = 75,
