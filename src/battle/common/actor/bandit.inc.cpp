...
Formation CoinFormation = {
    ACTOR_BY_POS(battle::actor::Coin, CoinPos, 0),
};
...
EvtScript EVS_HandleEvent = {
    ...
    Switch(LVar0)
        CaseEq(EVENT_HIT_COMBO)
            ExecGetTID(EVS_DropCoin, ArrayVar(0))
...
ActorBlueprint Bandit = {
    .flags = 0,
    .maxHP = bandit::hp,
    .type = ACTOR_TYPE_BANDIT,
    .level = ACTOR_LEVEL_BANDIT,
    .partCount = ARRAY_COUNT(bandit::ActorParts),
    .partsData = bandit::ActorParts,
    .initScript = &bandit::EVS_Init,
    .statusTable = bandit::StatusTable,
    .escapeChance = 40,
    .airLiftChance = 90,
    .hurricaneChance = 90,
    .spookChance = 90,
...
ActorBlueprint Coin = {
    ...
    .type = ACTOR_TYPE_BANDIT,
    .level = ACTOR_LEVEL_BANDIT,
    .partCount = ARRAY_COUNT(bandit::CoinParts),
    .partsData = bandit::CoinParts,
    .initScript = &bandit::EVS_Init_Coin,
    .statusTable = bandit::StatusTable,
    .escapeChance = 40,
    .airLiftChance = 90,
    .hurricaneChance = 90,
