...
extern EvtScript EVS_Attack_WindBlast;
extern EvtScript EVS_Attack_FeatherFling;
extern EvtScript EVS_Attack_GrappleDrop;
extern EvtScript EVS_Attack_ClawSwipe;
extern EvtScript EVS_FlyToHome;
extern EvtScript EVS_FlyToHome_GrappleFail;
extern EvtScript EVS_FlyToHome_Impl;
extern EvtScript EVS_FlyToHome_GrappleFail_Impl;
extern EvtScript EVS_DummyHit;
...
// Buzzar Actor Stats
constexpr s32 hp = 40;
constexpr s32 dmgFeather = 2;
constexpr s32 dmgSwipe = 3;
constexpr s32 dmgDrop = 4;
...
EvtScript EVS_TakeTurn = {
    ...
    Switch(LVar0)
        ...
        CaseDefault
            ...
            ExecWait(EVS_Attack_GrappleDrop)
    EndSwitch
...
EvtScript EVS_Attack_WindBlast = {
...
EvtScript EVS_Attack_FeatherFling = {
    Call(UseIdleAnimation, ACTOR_SELF, FALSE)
    Call(EnableIdleScript, ACTOR_SELF, IDLE_SCRIPT_DISABLE)
    Call(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
    Call(SetGoalToTarget, ACTOR_SELF)
    ...
    Wait(2)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_NO_CONTACT, 0, 0, dmgFeather, BS_FLAGS1_TRIGGER_EVENTS)
    Set(LVarF, LVar0)
    Switch(LVarF)
        CaseDefault
            Thread
...
EvtScript EVS_Attack_GrappleDrop = {
    Call(UseIdleAnimation, ACTOR_SELF, FALSE)
    Call(EnableIdleScript, ACTOR_SELF, IDLE_SCRIPT_DISABLE)
    Call(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
    Call(SetGoalToTarget, ACTOR_SELF)
    ...
    Switch(LVarA)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            IfEq(LVarA, HIT_RESULT_LUCKY)
                Call(EnemyTestTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_TRIGGER_LUCKY, 0, 0, 0)
            EndIf
            ExecWait(EVS_FlyToHome_GrappleFail)
            Call(EnableIdleScript, ACTOR_SELF, IDLE_SCRIPT_ENABLE)
            Call(UseIdleAnimation, ACTOR_SELF, TRUE)
            Return
        EndCaseGroup
        CaseEq(HIT_RESULT_IMMUNE)
            ...
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, 0, 0, dmgDrop, BS_FLAGS1_TRIGGER_EVENTS)
            Call(SetGoalToTarget, ACTOR_SELF)
    ...
    ExecGetTID(EVS_LiftMario, LVarA)
    Wait(62)
...
EvtScript EVS_Attack_ClawSwipe = {
    Call(UseIdleAnimation, ACTOR_SELF, FALSE)
    Call(EnableIdleScript, ACTOR_SELF, IDLE_SCRIPT_DISABLE)
    Call(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
    Call(SetGoalToTarget, ACTOR_SELF)
    ...
    Wait(2)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, 0, 0, dmgSwipe, BS_FLAGS1_TRIGGER_EVENTS)
    Set(LVarF, LVar0)
    Switch(LVarF)
        CaseOrEq(HIT_RESULT_HIT)
        CaseOrEq(HIT_RESULT_NO_DAMAGE)
...
EvtScript EVS_FlyToHome = {
    ExecWait(EVS_FlyToHome_Impl)
    Return
    End
};

EvtScript EVS_FlyToHome_GrappleFail = {
    ExecWait(EVS_FlyToHome_GrappleFail_Impl)
    Return
    End
};

EvtScript EVS_FlyToHome_Impl = {
    Call(GetAnimation, ACTOR_SELF, PRT_MAIN, LVar0)
    Switch(LVar0)
        CaseOrEq(ANIM_Buzzar_Anim01)
        CaseOrEq(ANIM_Buzzar_Anim02)
...
EvtScript EVS_FlyToHome_GrappleFail_Impl = {
    Call(GetAnimation, ACTOR_SELF, PRT_MAIN, LVar0)
    Switch(LVar0)
        CaseOrEq(ANIM_Buzzar_Anim01)
        CaseOrEq(ANIM_Buzzar_Anim02)
...
ActorBlueprint Buzzar = {
    .flags = ACTOR_FLAG_FLYING,
    .maxHP = buzzar::hp,
    .type = ACTOR_TYPE_BUZZAR,
    .level = ACTOR_LEVEL_BUZZAR,
    .partCount = ARRAY_COUNT(buzzar::ActorParts),
    .partsData = buzzar::ActorParts,
    .initScript = &buzzar::EVS_Init,
    .statusTable = buzzar::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 0,
