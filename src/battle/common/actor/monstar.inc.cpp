...
API_CALLABLE((UpdateMonstarImgFX)) {
    ...
    set_npc_imgfx_comp(part->spriteInstanceID, 1, IMGFX_OVERLAY, (s32)&MonstarDetailTexture, 255, 0, 255, 0);
...
EvtScript EVS_Attack_StarStorm = {
    Call(UseIdleAnimation, ACTOR_SELF, FALSE)
    Call(SetActorVar, ACTOR_SELF, AVAR_HoverPaused, TRUE)
    Call(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
    ...
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_COSMIC | DAMAGE_TYPE_NO_CONTACT, 0, 0, dmgStarStorm, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
...
ActorBlueprint Monstar = {
    .flags = ACTOR_FLAG_FLYING,
    .maxHP = monstar::hp,
    .type = ACTOR_TYPE_MONSTAR,
    .level = ACTOR_LEVEL_MONSTAR,
    .partCount = ARRAY_COUNT(monstar::ActorParts),
    .partsData = monstar::ActorParts,
    .initScript = &monstar::EVS_Init,
    .statusTable = monstar::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 0,
